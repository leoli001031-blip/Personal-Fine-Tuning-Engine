#!/usr/bin/env python3
"""Run and persist the Phase47 simulated-review validation matrix."""
...
def main() -> int:
    ...
    checks = [
        (
            ...
            [
                ...
                "-m",
                "py_compile",
                "pfe-core/pfe_core/phase47_simulated_user_review.py",
                "tools/phase47_simulated_user_review.py",
                "tools/phase47_validate.py",
                "tests/test_phase47_simulated_user_review.py",
            ],
        ),
        (
            "phase47_focused_and_phase46_phase45_regression",
            [
                python,
                "-m",
                "pytest",
        ...
        (
            "phase47_evidence_regeneration",
            [python, "tools/phase47_simulated_user_review.py"],
        ),
    ...
    summary = {
        "kind": "phase47_validation_summary",
        "created_at": _utcnow(),
    ...
    lines = [f"Phase47 validation: {summary['status']}"]
    lines.extend(

#!/usr/bin/env python3
"""Run and persist the Phase49 release validation matrix."""
...
def _evidence_check() -> dict[str, Any]:
    ...
    decision = json.loads((EVIDENCE_ROOT / "phase49-final-decision.json").read_text(encoding="utf-8"))
    ...
    passed = (
        ...
        and int(comparison.get("invalidated_debug_qwen_real_model_calls") or 0) == 192
    ...
    return {
        "name": "phase49_evidence_consistency",
        "command": ["internal", "phase49_evidence_consistency"],
        ...
        "output_tail": [
            ...
            f"debug_qwen={comparison.get('invalidated_debug_qwen_real_model_calls')} "
...
def main() -> int:
    ...
    checks = [
        (
            ...
            [
                ...
                "-m",
                "py_compile",
                "pfe-core/pfe_core/phase49_provenance_boundary_recovery.py",
                "tools/phase49_prepare.py",
                "tools/phase49_qwen3_4b_generate.py",
                "tools/phase49_blind_eval.py",
                "tools/phase49_finalize_evidence.py",
                "tools/phase49_validate.py",
                "tests/test_phase49_provenance_boundary_recovery.py",
            ],
        ),
        (
            "phase49_focused_and_phase48_47_46_45_regression",
            [
                python,
                "-m",
                "pytest",
    ...
    summary = {
        "kind": "phase49_validation_summary",
        "created_at": _utcnow(),
    ...
    lines = [f"Phase49 validation: {summary['status']}"]
    lines.extend(

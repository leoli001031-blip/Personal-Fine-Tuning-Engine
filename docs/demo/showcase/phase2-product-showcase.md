...
- [web-materials/](web-materials/) is a materials pack for building an external showcase page.
- [web-materials/images/](web-materials/images/) contains selected webpage-ready screenshots.
- [web-materials/copy-blocks.md](web-materials/copy-blocks.md) contains reusable short copy blocks.
- [web-materials/evidence-map.md](web-materials/evidence-map.md) maps webpage sections to real evidence files.
- [web-materials/materials.json](web-materials/materials.json) is the machine-readable materials manifest.

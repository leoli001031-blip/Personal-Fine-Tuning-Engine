"""Candidate history and timeline formatting."""
...
from .operations_candidate_timeline_formatting import (
...
def format_candidate_history(result: Any, *, deps: OperationsHistoryFormattingDeps) -> str:
